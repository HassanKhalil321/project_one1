          ...
          Container(
              ...
              child: Column(
                children: [
                  ...
                  const Text("1-Basic Row with MainAxisAlignment.center",
...
''',
                  ...
                  const Text("2- Column with MainAxisAlignment.spaceBetween",
                      textAlign: TextAlign.left,
                      style: TextStyle(
                          color: Color.fromRGBO(255, 215, 0, 1),
                          fontSize: 25,
...
''',
                  ...
                  const Text("3- Row and Column Combination",
                      textAlign: TextAlign.left,
                      style: TextStyle(
                          color: Color.fromRGBO(255, 215, 0, 1),
                          fontSize: 25,
  ...
  children: [
    ...
    SizedBox(width: 20), // Spacer between Row and Column
    Column(
